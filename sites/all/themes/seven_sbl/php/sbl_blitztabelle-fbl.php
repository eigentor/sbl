...
document.write('<thead><tr><th colspan="3" class="panel-heading-table" style="background-color:#<?=$bgcolor?>;color:#<?=$headingcolor?>">Tabelle der FBL</th></tr>');
...
<?php
$xml=simplexml_load_file("https://www.schachbundesliga.de/rss/522/560/tabelle-frauen-bundesliga.xml") or die("Fehler: Feed konnte nicht geladen werden");
$aktuelle_saison=562;
...
?>
document.write('<tr><td colspan="3" class="panel-footer-table" style="background-color:#<?=$bgcolor?> !important;"><a href="https://www.schachbundesliga.de/tabelle-frauen-bundesliga/<?=$aktuelle_saison?>/560"><img src="https://schachbundesliga.de/sites/all/themes/seven_sbl/php/images/logo.png" style="margin-left:5px;" /></a></td></tr></table><br /><div style="text-align:right"><a href="https://www.schachbundesliga.de/tabelle-frauen-bundesliga/<?=$aktuelle_saison?>/560" class="link_to_team" style="color:#<?=$linkcolor?> !important;font-size:12px;">>> Zur ausführlichen Tabelle</a></div></div></div>');
