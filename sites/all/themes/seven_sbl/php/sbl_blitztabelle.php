...
?>
document.write('<tr><td colspan="3" class="panel-footer-table" style="background-color:#<?=$bgcolor?> !important;"><a href="https://www.schachbundesliga.de/tabelle/<?=$aktuelle_saison?>/517"><img src="https://schachbundesliga.de/sites/all/themes/seven_sbl/php/images/logo.png" style="margin-left:5px;" /></a></td></tr></table><br /><div style="text-align:right"><a href="https://www.schachbundesliga.de/tabelle/<?=$aktuelle_saison?>/517" class="link_to_team" style="color:#<?=$linkcolor?> !important;font-size:12px;">>> Zur ausführlichen Tabelle</a></div></div></div>');
